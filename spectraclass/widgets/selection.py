from ipywidgets.widgets.widget_description import DescriptionWidget, DescriptionStyle
...
def _make_options(x):
    ...
    * an iterable of values, and labels will be generated
    ...
    if isinstance(x, Mapping):
        import warnings
        warnings.warn("Support for mapping types has been deprecated and will be dropped in a future release.",
                      DeprecationWarning)
