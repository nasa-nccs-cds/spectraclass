...
from spectraclass.ext.umap.distances import pairwise_special_metric, SPECIAL_METRICS
from spectraclass.ext.umap.sparse import SPARSE_SPECIAL_METRICS, sparse_named_distances
