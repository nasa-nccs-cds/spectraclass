...
from spectraclass.ext.pynndescent.utils import (
    tau_rand_int,
    tau_rand,
    make_heap,
    deheap_sort,
...
from spectraclass.ext.pynndescent.rp_trees import (
    make_forest,
    rptree_leaf_array,
    convert_tree_format,
    FlatTree,
...
class NNDescent(object):
    ...
    def _init_sparse_search_function(self):
        ...
        from spectraclass.ext.pynndescent.distances import alternative_dot, alternative_cosine
...
class PyNNDescentTransformer(BaseEstimator, TransformerMixin):
    ...
    >>> from spectraclass.ext.pynndescent import PyNNDescentTransformer
