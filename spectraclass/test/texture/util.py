...
def plot( axs: np.ndarray, iP: int, data: np.ndarray, title: str, cmap: str = 'nipy_spectral' ) -> AxesImage:
    if axs.ndim == 2:
...
def plot2( axs: np.ndarray, i0: int, i1: int, data: np.ndarray, title: str, cmap: str = 'nipy_spectral' ) -> AxesImage:
