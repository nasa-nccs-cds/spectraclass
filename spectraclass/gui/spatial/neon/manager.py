...
class BlockSelection(param.Parameterized):
    ...
    def block_selected(self, bid: Tuple) -> bool:
        return (bid in self.selected_rectangles)
    ...
    @property
    def selected_rectangles(self) -> Dict[Tuple,Tuple]:
...
class NEONTileSelector:
    ...
    def select_region(self, event ):
        ufm().show("Select Region")
        self.blockSelection.select_region(self.box_selection_stream.data)
    ...
    def clear_region(self, event ):
        ufm().show("Clear Region")
        self.blockSelection.clear_region(self.box_selection_stream.data)
    ...
    def get_block_selection(self) -> Optional[Dict]:
        return self.blockSelection.selected_rectangles
