...
#         return img
        ...
        if os.path.exists(block_data_file):
            ...
            if raw_data is not None:
                ...
                if baseline_spectrum is not None:
                    data_vars['baseline'] = baseline_spectrum
    ...
    def dataFile( self, **kwargs ):
        ...
        lgm().log( f"dataFile: bindex={bindex}, tm().block_index={tm().block_index}, kwargs:{list(kwargs.keys())}, block==None: {block==None}, file_name={file_name}")
